...
public class YahooFinance {
    ...
    public String requestData(List<String> tickers) throws MyExceptionMaster {
        ...
        try {
            ...
            throw new MyExceptionMaster("Broken Url");
        }
        ...
        try {
            ...
            throw new MyExceptionMaster("Can't connect to the Internet");
        }
    ...
    public void fetchAssetName(Asset asset) throws MyExceptionMaster {
    ...
    public YahooResponse getCurrentData(List<String> tickers) throws MyExceptionMaster {
